...
function init() {
    ...
    sandboxIframe.onload = () => {
        ...
        try {
            ...
            console.log("✅ MODEL_URL message sent");
        } catch (err) {
            console.error("❌ Failed to send model URL:", err);
        }
    };
